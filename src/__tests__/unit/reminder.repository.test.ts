...
import { Reminder, ReminderStatus, ReminderSource, ReminderFilter } from '../../models/reminder.model';
import { Pool } from 'pg';
...
describe('ReminderRepository - Unit Tests', () => {
  ...
  describe('delete', () => {
    it('should soft delete reminder', async () => {
      mockPool.query.mockResolvedValue({ rows: [{ id: 'reminder-123' }], rowCount: 1 });
